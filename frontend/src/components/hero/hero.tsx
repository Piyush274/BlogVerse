...
import { Sparkles, PenTool, ArrowRight, UserPen } from "lucide-react";
    ...
    <section className="relative overflow-hidden">
      ...
      <div className="mx-auto max-w-7xl px-6 pt-24 pb-16 sm:pt-32 lg:flex lg:px-8 lg:py-40">
        ...
        <div className="mx-auto mt-16 flex max-w-2xl sm:mt-24 lg:ml-10 lg:mr-0 lg:mt-0 lg:max-w-none lg:flex-none">
          ...
          >
            <div className="absolute -top-16 -left-16 w-32 h-32 rounded-full bg-purple-600/20 blur-3xl" />
            <div className="absolute -bottom-16 -right-16 w-32 h-32 rounded-full bg-primary/20 blur-3xl" />

            {/* Mock blog post preview */}
            <div className="bg-background/80 backdrop-blur rounded-xl h-full p-6 flex flex-col justify-between">
              <div>
                ...
                <h3 className="text-xl font-bold mb-2">How Modern Web Architecture Transforms Creation</h3>
                <p className="text-muted-foreground text-sm mb-4 line-clamp-3">
                  Explore how modern full-stack architectures unlock rich dynamic experiences, realtime interaction, and seamless scalability for creators worldwide.
                </p>
              </div>
